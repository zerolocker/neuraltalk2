...
opt = {
	binfilename = '/work/04006/zhuode93/maverick/talk/word2vec.torch/GoogleNews-vectors-negative300.bin',
	outfilename = '/work/04006/zhuode93/maverick/talk/word2vec.torch/word2vec.t7'
}
local w2vutils = {}
...
w2vutils.UNK = w2vutils.M[w2vutils.w2vvocab['UNK']]
